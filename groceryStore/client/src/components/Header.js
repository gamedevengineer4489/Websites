            ...
            default:
                return(
                    [
                        ...
                        <li key = "5"><Link className = "sidenav-close" to = "/shop">Groceries</Link></li>,
                        <li key = "6"><Link className = "sidenav-close" to = "/coffeeShop">Coffee Shop</Link></li>,
            ...
            <div style={{ position: 'fixed', width: '100%', top: '0'}}>
                <nav>
                    <div className='nav-wrapper blue'>
                        <ul>
                            {this.renderButtons()}
                            <Link className = "brand-logo right" to = "/" style={{ padding: '4px', color: 'orangered', marginLeft: '140px', marginTop: '-5px' }}>Dalessi Groceries</Link>
