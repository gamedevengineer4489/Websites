            ...
            <div style = {{maxHeight: '10000px'}} >
                <div style = {{ overflow: this.state.show ? 'hidden' : 'auto', position: this.state.show ? 'fixed' : 'static'}}>
                    <center>
                        ...
                        <br />
                        <img id = "pic13" src = {Lemonade1} style = {{ maxWidth: '60%', maxHeight: '100%', width: 'auto', height: 'auto', cursor: 'pointer'}} onClick={() => this.showModal(Lemonade1, "pic13")}/>
                        <br />
                        <img id = "pic14" src = {Lemonade2} style = {{ maxWidth: '60%', maxHeight: '100%', width: 'auto', height: 'auto', cursor: 'pointer'}} onClick={() => this.showModal(Lemonade2, "pic14")}/>
                        <br />
                        <img id = "pic15" src = {Lemonade3} style = {{ maxWidth: '60%', maxHeight: '100%', width: 'auto', height: 'auto', cursor: 'pointer'}} onClick={() => this.showModal(Lemonade3, "pic15")}/>
                        <br />
                        <img id = "pic16" src = {Lemonade4} style = {{ maxWidth: '60%', maxHeight: '100%', width: 'auto', height: 'auto', cursor: 'pointer'}} onClick={() => this.showModal(Lemonade4, "pic16")}/>
                    </center>
