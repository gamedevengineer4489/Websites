        ...
        return(
            <div>
                    ...
                    <form name = "loginForm">
                        ...
                        Reenter New Password: <input type = "password" name = "password" placeholder = "reenter password" onChange = {(event) => this.setState({ reenteredPassword: event.target.value })} required/>
